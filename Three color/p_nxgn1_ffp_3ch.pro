...
; generate background using N-9 to N green frames when the green laser is on
openr, 1, run + ".pma"
         ...
         if x eq 0 then begin
          if y eq 0 then begin
              ...
              if quality eq 1 then begin
                 ...
                 back(no_good) = aves1(x,y) ;frank for Cy3 background subtraction
                 no_good = no_good + 1
                 good(0,no_good) = xf
                 good(1,no_good) = yf
                 back(no_good) = aves1(int_xf,int_yf) ;frank for Cy5 background subtraction
                 no_good = no_good + 1
                 good(0,no_good) = xf2
                 good(1,no_good) = yf2
                 back(no_good) = aves1(int_xf2,int_yf2) ;frank for Cy7 background subtraction
                 no_good = no_good + 1
              endif
          endif
         endif
